    ...
    render() {
        return (
            <div className="page-text">
                ...
                <p>To that end, Like A Native provides customizable charts that automatically switch data to display the consonants and vowels used in your target language, featuring audio recordings for each phoneme to help you become accustomed to the sounds.</p>
            </div>
        );
    }
};
